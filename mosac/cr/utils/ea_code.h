...
class ExAccCodeInterface : public LinearCodeInterface {
 public:
  ...
  virtual void DualEncode(absl::Span<internal::PTy> in, /* PRIME FIELD */
                          absl::Span<internal::PTy> out) const = 0;
  virtual void DualEncode2(absl::Span<internal::PTy> in0, /* PRIME FIELD */
                           absl::Span<internal::PTy> out0,
                           absl::Span<internal::PTy> in1, /* PRIME FIELD */
                           absl::Span<internal::PTy> out1) const = 0;
};

// Implementation of expand accumulate code in PRIME FIELD, for more details,
// see original paper: https://eprint.iacr.org/2022/1014.pdf section 3.1
//
...
class ExAccCode : public ExAccCodeInterface {
 public:
  ...
  void DualEncode(absl::Span<internal::PTy> in,
                  absl::Span<internal::PTy> out) const override {
    DualEncodeImpl<internal::PTy>(in, out);
  }

  void DualEncode2(absl::Span<internal::PTy> in0,
                   absl::Span<internal::PTy> out0,
                   absl::Span<internal::PTy> in1,
                   absl::Span<internal::PTy> out1) const override {
    DualEncode2Impl<internal::PTy, internal::PTy>(in0, out0, in1, out1);
  }
