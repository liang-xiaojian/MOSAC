...
//
// Note :
//  - FakeCorrelation (Fake CR) is provided only for benchmarking and
//    performance evaluation. It intentionally uses simulated randomness
//    and MUST NOT be used in production or for security-sensitive
//    deployments.
//
...
void FakeCorrelation::DoubleASTGet_2k(size_t T, absl::Span<internal::ATy> a,
                                      absl::Span<internal::ATy> b,
...
std::vector<size_t> FakeCorrelation::DoubleASTSet_2k(
